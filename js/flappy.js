...
function Gasolina(alturaJogo,larguraJogo,notificarPonto,passaro){
    this.elemento = novoElemento('img', 'ferramenta')
    this.elemento.src = 'img/gasolina.png'
    const imagensE = ['./img/gasolina.png']; 
    const direcaoX = [2.4,-2.4,0]
    const incrementoY = [1,2,5]
    let incrementoAtualY = 0
    let incrementoAtualX = 0
...
/* 
    ...
    areaDoJogo.appendChild(gasolina.elemento)
